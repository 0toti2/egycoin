...
uint256 hashGenesisBlock("0xf54949de09a8cedc9f696bd28a6cdd657357659e8c2741a83efab8458a580aa8");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // EgyCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "EgyCoin Signed Message:\n";
...
{
    // EgyCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // EgyCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // EgyCoin: 3.5 days
static const int64 nTargetSpacing = 150; // EgyCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // EgyCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // EgyCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // EgyCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4308fa4c6cb9e6232f19fc622c3cb057aafc7e0d570aaee29a68ac0ab0993988");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("fd29784e1c4cbece5b4008256df98907c75ef9e2996b1be400c74e142900f8d1924d8614432fd3e9ad5b05f02bbcaf7707354f1596a532805ef301a9682733987b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1492192394;
        block.nBits    = 504365644;
        block.nNonce   = 2140587224;

        if (fTestNet)
        {
            block.nTime    = 1492192394;
            block.nNonce   = 385843065;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5350e617b4485648671ce53a68c22e15cb4caf98763f2b3744ee37e2bb4cb9d8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // EgyCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("EgyCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("EgyCoinMiner : ProcessBlock, block not accepted");
    }
